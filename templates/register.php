        ...
        <main class="content__main">
          ...
          <form class="form" action="index.php" method="post">
            ...
            <div class="form__row">
              ...
              <input class="form__input <?php if (isset($errors['name'])) print('form__input--error')?>" type="text" name="name" id="name" value="<?php if (isset($values['name'])) print($values['name']) ?>" placeholder="Введите имя">

              <p class="form__message"><?php if (isset($errors['name'])) print($errors['name'])?></p>
            </div>

            <div class="form__row form__row--controls">
              <p class="error-message"><?php if (isset($errors)) print('Пожалуйста, исправьте ошибки в форме') ?></p>
